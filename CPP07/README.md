...
and at compile time(at the linker stage to be exacte) ,the compiler change the data type
...
the header file (the compiler needs to see the template implemnetaion on hpp file, it
